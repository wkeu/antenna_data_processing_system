...
"""
This script is kinda messy. It was built as quickly as possible to get it done 
so it was written as a self contained unit and dosn't fit perfectly into the 
rest of the systme. If time it should be reorganised into a more logical architechture
For example moving the plotting functions into antenna_plots.py . But it works.

TODO: Add error checking functions. 
"""
